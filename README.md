This program runs to create a simulation of a traffic intersection with traffic lights, crosswalk buttons, a crosswalk buzzer, directional lights, and an emergency traffic light override button. 
